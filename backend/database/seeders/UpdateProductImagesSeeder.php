...
class UpdateProductImagesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $imageMap = [
            ...
            'Samsung Galaxy A54 5G' => ['assets/images/products/a535g_image_1.avif', 'assets/images/products/a535g_image_2.avif'],
            'Samsung Galaxy A53 5G' => ['assets/images/products/a535g_image_1.avif', 'assets/images/products/a535g_image_2.avif'],
            'Samsung Galaxy S24 5G' => ['assets/images/products/s545g_image_1.webp', 'assets/images/products/s545g_image_2.avif'],
